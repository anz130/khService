...
import com.dyb.dybc.util.PinyinUtils;
...
public class CityPickerListAdapter extends BaseAdapter {
    ...
    public CityPickerListAdapter(Context mContext, List<City> mCities) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        switch (viewType){
            case 0:     //定位
                view = inflater.inflate(R.layout.activity_city_picker_local_view, parent, false);
            ...
            case 1:
                if (view == null){
                    view = inflater.inflate(R.layout.activity_city_picker_listview_item, parent, false);
