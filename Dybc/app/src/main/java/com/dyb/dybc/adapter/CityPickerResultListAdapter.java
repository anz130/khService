 ...
 * zhangyong
 */
public class CityPickerResultListAdapter extends BaseAdapter {
    private Context mContext;
    private List<City> mCities;

    public CityPickerResultListAdapter(Context mContext, List<City> mCities) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null){
            view = LayoutInflater.from(mContext).inflate(R.layout.activity_city_picker_result_item, parent, false);
